...
// NOTE: you should only define rules for those attributes that
		...
		return array(
			array('continentID', 'numerical', 'integerOnly'=>true),
			array('continentName', 'length', 'max'=>25),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('continentID, continentName', 'safe', 'on'=>'search'),
		);
	}
...
"countries"=>array(self::HAS_MANY, 'Countries', 'continentID'),
